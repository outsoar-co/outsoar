<template>
    <svg
        ...
        class="fill-current hover:text-outsoar"
    >
        <defs>
            <linearGradient
        ...
        <ellipse cx="468.63" cy="660.88" rx="425" ry="33" opacity="0.1" />
        <g opacity="0.1">
            <path
            ...
            <path
                ...
                opacity="0.1"
            />
            <circle cx="925.49" cy="102.72" r="10.69" />
            <circle cx="987.93" cy="109.58" r="10.69" />
            <circle cx="1012.01" cy="205.64" r="10.69" />
            <circle cx="979.51" cy="253.61" r="10.69" />
            <circle cx="935.11" cy="353.24" r="10.69" />
            <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
            <circle cx="836.39" cy="240.4" r="10.69" />
        ...
        <g opacity="0.1">
            ...
            <path
                ...
                opacity="0.1"
            />
            <circle cx="48.97" cy="324.78" r="5.39" />
            <circle cx="17.51" cy="328.24" r="5.39" />
            <circle cx="5.39" cy="376.63" r="5.39" />
        ...
        <path
            ...
            opacity="0.1"
        />
        <ellipse cx="615.63" cy="756.88" rx="115" ry="20" opacity="0.1" />
        <polygon
        ...
        <ellipse cx="813.11" cy="655.78" rx="32.29" ry="6.21" />
        ...
        <path
            ...
            opacity="0.1"
        />
        <ellipse cx="148.42" cy="776.87" rx="46.49" ry="8.94" />
